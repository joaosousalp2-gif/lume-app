...
export default function FloatingAIAssistant() {
  ...
  return <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3" aria-label="Atalhos do Agente IA">
    {open && <div className="w-72 rounded-2xl border border-blue-100 bg-white p-3 shadow-2xl" role="menu" aria-label="Ações rápidas do Agente IA">
